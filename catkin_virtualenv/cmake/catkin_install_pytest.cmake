...
#
# \file      catkin_install_pytest.cmake
...
function(catkin_install_pytest)
  # See https://github.com/ros/catkin/blob/kinetic-devel/cmake/catkin_install_pytest.cmake for overriden function
  cmake_parse_arguments(ARG "OPTIONAL" "DESTINATION" "PROGRAMS" ${ARGN})
  if(NOT ARG_PROGRAMS)
    message(FATAL_ERROR "catkin_install_pytest() called without required PROGRAMS argument.")
  endif()
  if(NOT ARG_DESTINATION)
    message(FATAL_ERROR "catkin_install_pytest() called without required DESTINATION argument.")
  endif()
...
will not work as expected.")
      ...
      set(project_venv_devel_dir ${${PROJECT_NAME}_VENV_DEVEL_DIR})
      configure_file(${catkin_virtualenv_CMAKE_DIR}/templates/test.devel.in ${devel_program} @ONLY)
      execute_process(
      ...
      set(project_venv_install_dir ${${PROJECT_NAME}_VENV_INSTALL_DIR})
      configure_file(${catkin_virtualenv_CMAKE_DIR}/templates/test.install.in ${install_program} @ONLY)
      execute_process(
    ...
    elseif(NOT ARG_OPTIONAL)
      message(FATAL_ERROR "catkin_install_pytest() called with non-existent file '${program_path}'.")
    endif()
  endforeach()
